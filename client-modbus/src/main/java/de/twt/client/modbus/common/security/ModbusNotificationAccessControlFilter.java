package de.twt.client.modbus.common.security;
...
public class ModbusNotificationAccessControlFilter extends ArrowheadFilter {
			...
			try {
				...
				if (eventTypeMap != null) {					
					for (final String notificationUri : eventTypeMap.values()) {						
						if (requestTarget.endsWith( ModbusSecurityConstants.DEFAULT_EVENT_NOTIFICATION_BASE_URI + "/" + notificationUri )) {							
